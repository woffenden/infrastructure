...
terraform {
  backend "s3" {
    ...
    workspace_key_prefix = "cloud-platform-tenants/TENANT_NAME"
...
provider "aws" {
  ...
  default_tags {
    tags = {
      ...
      "component"     = "main"
      "owner"         = "OWNER"
      "source-code"   = "github.com/woffenden/infrastructure/terraform/aws/cloud-platform-tenants/TENANT_NAME"
