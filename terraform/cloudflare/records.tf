resource "cloudflare_record" "woffenden_cloud_aws_ns1" {
  ...
  name    = "aws"
  type    = "NS"
  content = "ns-1682.awsdns-18.co.uk"
}
...
resource "cloudflare_record" "woffenden_dev_github_pages_challenge" {
  ...
  type    = "TXT"
  content = "3ff9951c0a51b83dca75b05f205366"
}
...
resource "cloudflare_record" "woffenden_family_paperless_cname" {
  ...
  name    = "paperless"
  type    = "CNAME"
  content = cloudflare_tunnel.paperless_woffenden_family.cname
  proxied = true
}
...
resource "cloudflare_record" "woffenden_io_github_pages_challenge" {
  ...
  name    = "_github-pages-challenge-woffenden"
  type    = "TXT"
  content = "3e8f0954722b4e4341b822e923bf87"
}
...
resource "cloudflare_record" "woffenden_net_homeassistant_cname" {
  zone_id = module.woffenden_net_cloudflare_zone.id
  name    = "homeassistant"
  type    = "CNAME"
  content = cloudflare_tunnel.bny_woffenden_net.cname
