terraform {
  backend "s3" {
    ...
    key            = "cloud-platform-shared-services/iam/terraform.tfstate"
...
provider "aws" {
  ...
  default_tags {
    tags = {
      ...
      "source-code"   = "github.com/woffenden/infrastructure/terraform/aws/cloud-platform-shared-services/iam"
